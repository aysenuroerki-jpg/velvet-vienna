...
export const metadata: Metadata = {
  ...
  title: {
    default: "Velvet Vienna · Events & Organizations",
  ...
  openGraph: {
    title: "Velvet Vienna · Events & Organizations",
    description: "Persönliche Eventdekoration, Hintergründe, Gastgeschenke und Zeremoniedetails in Wien.",
    type: "website",
    locale: "de_AT",
    siteName: "Velvet Vienna",
    images: [{ url: "/og.png", width: 1672, height: 941, alt: "Velvet Vienna · Events & Organizations" }],
  },
  twitter: {
