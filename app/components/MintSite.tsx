...
const itemDescriptionTranslations: Record<Lang, Record<string, string>> = {
  de: {
    "Scarlet Feather": "Auf Wunsch personalisierbar", "Burgundy Tef": "Spezielles Tef für die Braut · Auf Wunsch personalisierbar", "Midnight Masks": "Auf Wunsch personalisierbar", "Instant Memories": "Inklusive 20 Aufnahmen", "Davul Kiralama": "Auf Wunsch personalisierbar", "rental-crimson-garden": "Roter Teppich und Henna-Thron können separat gemietet werden.", "Initials in Ivory": "Personalisierung möglich", "gift-canvas-bag": "Auf Wunsch personalisierbar", "gift-bridal-fan": "Auf Wunsch personalisierbar",
  },
  tr: {
    "Sarı & Orange Garden": "Çiçekler · Kumaş · Açık alan", "White Geometry": "Tekstil · Geometri · Beyaz", "Rosé & Gold": "Pudra pembe · Işık · Altın", "Luminous White": "Işık kemerleri · Çiçek tasarımı", "Butterfly Geometry": "Tekstil · Kelebek detayları", "White Circle": "Masa · Yuvarlak kemer · Çiçekler", "Pearl Light": "Sedef · Işık · Çiçek tasarımı", "Crimson Garden": "Taht · Halı · Fenerler", "rental-crimson-garden": "Kırmızı Halı ve Kına Tahtı ayrı ayrı kiralanabilir.", "Sage & Gold Garden": "Adaçayı yeşili · Altın · Çiçekler", "Davul & Drapes": "Taht · Davul · Kumaş", "Pampas Heart": "Kalp kemeri · Pampas · Kırmızı", "Heart Curtain": "Kumaş · Kalpler · Işık", "Blue Drapery": "Mavi · Pembe · Çiçekler", "Burgundy Circle": "Yuvarlak kemer · Kumaş · Çiçekler", "Kına Welcome": "Tüller · Ayna · Karşılama", "Burgundy Welcome": "Çiçekler · Kurdeleler · Mumlar", "Memory Table": "Kartlar · Mumlar · Çiçekler", "Burgundy Sweets": "Tatlılar · Tekstil · Mumlar", "Sweet Gathering": "Büfe · Çiçekler · Sunum", "Rustic Table": "Ahşap · Çiçekler · Mumlar", "Lace Welcome": "Dantel · Şövale · Çiçekler", "Butterfly Welcome": "Ayna · Kelebekler · Çiçekler", "Golden Reflection": "Kemer ayna · Altın · Çiçek tasarımı", "Castle Promise": "Göl · Şato · Evlilik teklifi", "Initials in Ivory": "Kişiselleştirme yapılır", "Scarlet Feather": "İsteğe göre kişiselleştirme yapılır", "Burgundy Tef": "Geline özel tef · İsteğe göre kişiselleştirme yapılır", "Midnight Masks": "İsteğe göre kişiselleştirme yapılır", "Instant Memories": "20 poz ile birlikte", "Davul Kiralama": "İsteğe göre kişiselleştirme yapılır", "gift-canvas-bag": "İsteğe göre kişiselleştirme yapılır", "gift-bridal-fan": "İsteğe göre kişiselleştirme yapılır",
  },
  en: { "Scarlet Feather": "Personalisation available on request", "Burgundy Tef": "Special tef for the bride · Personalisation available on request", "Midnight Masks": "Personalisation available on request", "Instant Memories": "Includes 20 shots", "Davul Kiralama": "Personalisation available on request", "rental-crimson-garden": "The red carpet and henna throne can be hired separately.", "Initials in Ivory": "Personalisation available", "gift-canvas-bag": "Personalisation available on request", "gift-bridal-fan": "Personalisation available on request" },
  ar: { "Scarlet Feather": "يمكن تخصيصه حسب الطلب", "Burgundy Tef": "دف خاص للعروس · يمكن تخصيصه حسب الطلب", "Midnight Masks": "يمكن تخصيصه حسب الطلب", "Instant Memories": "يشمل 20 لقطة", "Davul Kiralama": "يمكن تخصيصه حسب الطلب", "rental-crimson-garden": "يمكن استئجار السجادة الحمراء وعرش الحناء بشكل منفصل.", "Initials in Ivory": "التخصيص متاح", "gift-canvas-bag": "يمكن تخصيصه حسب الطلب", "gift-bridal-fan": "يمكن تخصيصه حسب الطلب" },
  ru: { "Scarlet Feather": "Персонализация по запросу", "Burgundy Tef": "Особый теф для невесты · Персонализация по запросу", "Midnight Masks": "Персонализация по запросу", "Instant Memories": "Включено 20 снимков", "Davul Kiralama": "Персонализация по запросу", "rental-crimson-garden": "Красную дорожку и трон для хны можно арендовать отдельно.", "Initials in Ivory": "Возможна персонализация", "gift-canvas-bag": "Персонализация по запросу", "gift-bridal-fan": "Персонализация по запросу" },
};
...
const copy = {
  de: {
    ...
    studioKicker: "Velvet Vienna Event · Wien",
  ...
  return (
    <div className="site-shell" dir={rtl ? "rtl" : "ltr"}>
      ...
      <header className={page === "home" ? "site-header site-header--overlay" : "site-header"}>
        <Link className="brand" href="/" aria-label="Velvet Vienna Event home">
          <img src={page === "home" ? "/brand/velvet-vienna-event-logo-cream.svg" : "/brand/velvet-vienna-event-logo-green.svg"} alt="Velvet Vienna Event" />
        </Link>
      ...
      <footer className="site-footer">
        <div><img src="/brand/velvet-vienna-event-logo-cream.svg" alt="Velvet Vienna Event" /><p>{t.footer}</p></div>
        <div className="footer-links">{navLinks.map((href, index) => <Link key={href} href={href}>{t.nav[index]}</Link>)}</div>
        <div><a href="mailto:velvetviennaevent@gmail.com">velvetviennaevent@gmail.com</a><a href="https://www.instagram.com/mintevents.vienna/" target="_blank" rel="noreferrer">Instagram ↗</a></div>
        <p className="copyright">© 2026 Velvet Vienna Event · {localeExtras[lang].city}</p>
      </footer>
...
function PortfolioPage({ t, filter, setFilter, items, open, lang }: { t: typeof copy.de; filter: string; setFilter: (value: string) => void; items: GalleryItem[]; open: (item: GalleryItem) => void; lang: Lang }) {
  ...
  return <>
    <section className="page-hero"><div className="page-hero__copy"><p className="kicker">{t.projectsKicker}</p><h1>{t.projectsTitle}</h1><p>{t.projectsText}</p><span className="page-count">{allProjects.length} · Velvet Vienna Event</span></div><div className="page-hero__image"><Picture item={heroItem} priority /></div></section>
...
function DetailsCatalog({ t, filter, setFilter, open, labels, lang }: { t: typeof copy.de; filter: string; setFilter: (value: string) => void; open: (item: GalleryItem) => void; labels: (typeof categoryLabels)[Lang]; lang: Lang }) {
  ...
  return <>
    <section className="page-hero"><div className="page-hero__copy"><p className="kicker">{t.detailsKicker}</p><h1>{t.detailsTitle}</h1><p>{t.detailsText}</p><span className="page-count">{count} · Velvet Vienna Event</span></div><div className="page-hero__image"><Picture item={ceremonyDetails[3]} priority /></div></section>
...
function Studio({ t, lang }: { t: typeof copy.de; lang: Lang }) {
  return <>
    ...
    <section className="studio-quote"><p>“</p><h2>{t.studioText}</h2><span>Velvet Vienna Event · {localeExtras[lang].city}</span></section>
    <Cta t={t} />
  </>;
}
